...
document.addEventListener('DOMContentLoaded', () => {
    ...
    analyzeBtn.addEventListener('click', async () => {
        ...
        // Show website scan card loading
        showWebsiteScanLoading(companyUrl ? 'Scanning website & database…' : null);

        // Run real-time network checks in parallel
        ...
        // Re-render with final updated scores
        renderResults(result);
